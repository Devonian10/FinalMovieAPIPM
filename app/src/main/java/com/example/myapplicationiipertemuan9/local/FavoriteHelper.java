package com.example.myapplicationiipertemuan9.local;
...
public class FavoriteHelper {
    ...
    private static final String TABLE_NAME = "favorite_tv";
    ...
    public long insert(TvShowPlaying tvShow) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues val = new ContentValues();
        val.put(ID, tvShow.getId());
        val.put(NAME, tvShow.getTitle());
